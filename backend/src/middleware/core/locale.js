...
translations.ur = {
  ...
  bom_error_department_must_be_production: "محکمہ پیداوار کا شعبہ ہونا چاہیے۔",
  ...
  bom_error_rm_line_invalid: "خام مال کی غلط لائن۔",
  ...
  bom_header: "BOM ہیڈر",
  bom_header_required_message: "پہلے BOM ہیڈر کو مکمل کریں۔",
  bom_list: "BOM کی فہرست",
  bom_new_title: "BOM شامل کریں۔",
  bom_normal_loss_pct: "عام نقصان %",
  bom_output_qty: "آؤٹ پٹ کی مقدار",
  bom_rm_rules_size_wise: "خام مال کے قواعد کے مطابق سائز",
  ...
  bom_specific: "مخصوص",
  bom_tab_labour: "لیبرز",
  bom_tab_rm: "خام مال",
  bom_tab_sfg: "نیم تیار شدہ مصنوعات",
