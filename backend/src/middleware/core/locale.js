...
const translations = {
  en: {
    ...
    recalculate_commission_description: "Recompute stored commission for a past date range using the rates active today.",
    commission_recalc_today_rates_warning: "Commission rules have no start or end date. This recalculates using the rates active today. If a rate has changed since these vouchers were created, check the Old and New columns before applying.",
...
translations.ur = {
  ...
  recalculate_commission_description: "گزشتہ تاریخوں کے کمیشن کو آج کی شرحوں سے دوبارہ شمار کریں۔",
  commission_recalc_today_rates_warning: "کمیشن قواعد کی کوئی ابتدائی یا آخری تاریخ نہیں ہوتی۔ یہ حساب آج کی فعال شرحوں سے ہوگا۔ اگر ان واؤچرز کے بعد شرح تبدیل ہوئی ہے تو لاگو کرنے سے پہلے پرانی اور نئی رقم دیکھ لیں۔",
