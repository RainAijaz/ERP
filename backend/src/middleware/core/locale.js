...
const translations = {
  en: {
    ...
    stock_count_accuracy_report_purpose_tooltip:
      "Trends how closely blind physical counts matched the system over time (week/month/year), split by category. Shows the trade-off between total unit (dozen) difference and total cost difference. Cost of a difference is the point-in-time WAC posted to the ledger; for matched lines the cost denominator uses current WAC (an approximation).",
...
translations.ur = {
  ...
  stock_count_accuracy_report_purpose_tooltip:
    "Waqt ke sath (ہفتہ وار/ماہانہ/سالانہ) physical count system se kitna match hua, category ke lihaz se dikhata hai. Total unit (درجن) فرق aur total cost فرق ke darmiyan trade-off dikhata hai. Farq ki cost ledger par posted point-in-time WAC hai; match shudہ lines ke liye cost denominator موجودہ WAC استعمال کرتا ہے (تخمینہ).",
  period_grain: "مدت کی سطح",
  accuracy_trend: "ایکوریسی رجحان",
  quantity_accuracy: "مقدار کی درستگی",
  cost_accuracy: "لاگت کی درستگی",
  unit_difference: "یونٹ فرق",
  cost_difference: "لاگت کا فرق",
  total_cost_difference: "کل لاگت کا فرق",
