...
const translations = {
  en: {
    ...
    technical_details: "Technical Details (Advanced)",
    ...
    commission_type_salesman_sale: "Salesman's Sale",
    commission_type_branch_sale: "Branch Sale",
    commission_type_transfer: "Transfer Commission",
    commission_type_party: "Party Commission",
    commission_type_production_fg: "Production Commission (FG)",
    commission_type_production_sfg: "Production Commission (SFG)",
    commission_rule: "Commission Rule",
    commission_unclassified: "Unclassified Commission",
    recalculate_commission: "Recalculate Commission",
    recalculate_commission_description: "Recompute stored commission for a past date range using the rates effective on each voucher date.",
    commission_recalc_today_rates_warning: "Commission rules use effective dates. This recalculates each voucher with the rate active on that voucher date. Check the Old and New columns before applying manual changes.",
    commission_recalc_clear_orphans_warning: "Unmatched commission will be set to zero. This removes commission that was already recorded and may already have been paid.",
    commission_recalc_unmatched: "Unmatched",
    commission_recalc_unmatched_hint: "These rows have stored commission that no active rule produces. They will not be changed unless you tick the box below.",
    commission_recalc_rules_applied: "Rules that will be applied",
    commission_recalc_no_rules: "No active commission rules match this selection.",
    commission_recalc_scanned: "Vouchers scanned",
    clear_unmatched_commission: "Also clear unmatched commission",
    ...
    run_preview: "Preview",
    apply_changes: "Apply",
    success_commission_recalculated: "Commission recalculated.",
    error_recalc_date_range_required: "Select both a start and an end date.",
    error_recalc_nothing_to_write: "Nothing to update for this selection.",
    error_recalc_over_limit: "Too many rows to apply at once. Narrow the date range or select a single employee.",
    rate_type: "Rate Type",
    ...
    error_recalc_nothing_to_write: "Nothing to update for this selection.",
    error_recalc_over_limit: "Too many rows to apply at once. Narrow the date range or select a single employee.",
    error_invalid_commission_type: "Invalid commission type selected.",
    ...
    pl_inventory_adjustments: "Inventory Adjustments (Loss/Gain)",
    pl_other_expenses: "Other Expenses",
    pl_finance_cost: "Finance Cost",
    pl_net_profit_before_tax: "Net Profit Before Tax",
    pl_cogs_basis:
      "Cost of stock issued against approved sales, valued at the cost actually charged. Opening inventory, purchases and closing inventory are shown for context; they are not the inputs.",
    ...
    supplier_analysis_purpose_tooltip:
      "Compares purchase rates for the same article across suppliers — highlights the cheapest source, the money spent above it (potential savings), supplier spend, and rates running above weighted-average cost.",
    by_article: "By Article",
    by_supplier: "By Supplier",
    only_multi_supplier_articles: "Only multi-supplier articles",
    min_price_spread_pct: "Min price spread %",
    articles_purchased: "Articles Purchased",
    multi_supplier_articles: "Multi-Supplier Articles",
    ...
    price_spread: "Spread %",
    article: "Article",
    articles_supplied: "Articles",
    cheapest_supplier: "Cheapest Supplier",
    dearest_supplier: "Highest Supplier",
    above_wac: "Above Avg Cost",
    above_wac_tooltip:
      "This supplier's average rate is above the item's weighted-average cost.",
    vs_cheapest: "vs Cheapest",
    rate_premium_vs_cheapest: "Avg Premium vs Cheapest",
    ...
    dead_stock_report: "Slow-Moving / Dead Stock Report",
    dead_stock_report_purpose_tooltip:
      "Shows closing stock quantity and value against quantity sold over a selected period, to identify slow-moving and dead stock articles.",
    stock_count_accuracy_report: "Stock Count Accuracy Report",
    stock_count_accuracy_report_purpose_tooltip:
      "Trends how closely blind physical counts matched the system over time (week/month/year), split by category. Shows the trade-off between total unit (dozen) difference and total value difference. Value is the selling price (sale rate) of finished/semi-finished goods; raw materials use their latest purchase rate, since they are never sold.",
    ...
    qty_sold_period: "Qty Sold (Period)",
    turnover_ratio: "Turnover Ratio",
    turnover_ratio_tooltip:
      "Qty Sold in the period divided by Closing Qty. Higher means faster-moving; near 0 means the article is barely selling relative to what's in stock.",
    days_of_stock_cover: "Days of Stock Cover",
    days_of_stock_cover_tooltip:
      "At the current average daily sales pace, how many days the closing stock would last. Higher means slower-moving; N/A means there were no sales in the period.",
    closing_qty: "Closing Qty",
    closing_value: "Closing Value",
    total_skus: "Total SKUs",
    dead_stock_sku_count: "Dead Stock SKUs",
    dead_stock_value: "Dead Stock Value",
    sort_by: "Sort By",
    sort_closing_qty_desc: "Most Overstocked First (Highest Qty)",
    sort_turnover_ratio_asc: "Slowest Moving First (Lowest Turnover)",
    sort_stock_value_desc: "Highest Value Tied Up First",
    stock_status_dead: "Dead",
    stock_status_slow: "Slow Moving",
    ...
    total_bill_amount_range: "Total Bill Amount Range",
    min_amount: "Min",
    max_amount: "Max",
    ...
    error_rm_uom_change_approved_bom: "Cannot change unit: this raw material is used in an approved BOM and no UOM conversion rule exists",
...
translations.ur = {
  ...
  total_bill_amount_range: "بل کی کل رقم کی حد",
  min_amount: "کم از کم",
  max_amount: "زیادہ سے زیادہ",
  sort_ascending: "چڑھتی ترتیب",
  sort_descending: "اترتی ترتیب",
  ...
  new_approval_request: "منظوری کی نئی درخواست",
  dozen_rate: "درجن ریٹ",
  ...
  commission_type: "کمیشن کی قسم",
  commission_type_salesman_sale: "سیلزمین کی فروخت",
  commission_type_branch_sale: "برانچ سیل",
  commission_type_transfer: "ٹرانسفر کمیشن",
  commission_type_party: "پارٹی کمیشن",
  commission_type_production_fg: "پیداوار کمیشن (تیار مال)",
  commission_type_production_sfg: "پیداوار کمیشن (نیم تیار مال)",
  commission_rule: "کمیشن رول",
  commission_unclassified: "غیر درجہ بند کمیشن",
  recalculate_commission: "کمیشن دوبارہ شمار کریں",
  recalculate_commission_description: "گزشتہ تاریخوں کے محفوظ کمیشن کو ہر واؤچر کی مؤثر شرح کے مطابق دوبارہ شمار کریں۔",
  commission_recalc_today_rates_warning: "کمیشن قواعد مؤثر تاریخوں کے مطابق چلتے ہیں۔ ہر واؤچر کا کمیشن اسی واؤچر کی تاریخ پر فعال ریٹ سے دوبارہ شمار ہوگا۔ دستی تبدیلی لاگو کرنے سے پہلے پرانی اور نئی رقم دیکھ لیں۔",
  commission_recalc_clear_orphans_warning: "غیر مطابقت شدہ کمیشن صفر کر دیا جائے گا۔ یہ پہلے سے درج شدہ کمیشن ختم کر دیتا ہے جو شاید ادا بھی ہو چکا ہو۔",
  commission_recalc_unmatched: "غیر مطابقت شدہ",
  commission_recalc_unmatched_hint: "ان سطروں میں درج کمیشن کسی فعال قاعدے سے نہیں بنتا۔ نیچے خانہ منتخب کیے بغیر یہ تبدیل نہیں ہوں گی۔",
  commission_recalc_rules_applied: "لاگو ہونے والے قواعد",
  commission_recalc_no_rules: "اس انتخاب کے لیے کوئی فعال کمیشن قاعدہ نہیں ہے۔",
  commission_recalc_scanned: "جانچے گئے واؤچرز",
  clear_unmatched_commission: "غیر مطابقت شدہ کمیشن بھی صفر کریں",
  changed_only: "صرف تبدیل شدہ",
  total_change: "کل تبدیلی",
  previous_rate: "پرانی",
  new_rate: "نئی",
  change: "تبدیلی",
  rows: "سطریں",
  run_preview: "جائزہ",
  apply_changes: "لاگو کریں",
  success_commission_recalculated: "کمیشن دوبارہ شمار ہو گیا۔",
  error_recalc_date_range_required: "ابتدائی اور آخری دونوں تاریخیں منتخب کریں۔",
  error_recalc_nothing_to_write: "اس انتخاب کے لیے کچھ تبدیل نہیں ہونا۔",
  error_recalc_over_limit: "ایک وقت میں بہت زیادہ سطریں ہیں۔ تاریخوں کا دورانیہ کم کریں یا ایک ملازم منتخب کریں۔",
  error_invalid_commission_type: "غلط کمیشن قسم منتخب کی گئی۔",
  ...
  error_rm_uom_change_approved_bom: "یونٹ تبدیل نہیں کیا جا سکتا: یہ خام مال ایک منظور شدہ BOM میں استعمال ہے اور کوئی UOM تبدیلی اصول موجود نہیں",
  ...
  in_transit: "زیرِ ترسیل",
  max: "زیاده سے زیادہ",
  qty_in_transit: "زیرِ ترسیل مقدار",
  days_in_transit: "زیرِ ترسیل دن",
  ...
  pl_inventory_adjustments: "انوینٹری ایڈجسٹمنٹ (نقصان/منافع)",
  pl_other_expenses: "دیگر اخراجات",
  pl_finance_cost: "مالی لاگت",
  pl_net_profit_before_tax: "ٹیکس سے پہلے خالص منافع",
  pl_cogs_basis:
    "منظور شدہ فروخت پر نکلے ہوئے سٹاک کی لاگت۔ ابتدائی انوینٹری، خریداریاں اور اختتامی انوینٹری صرف تناظر کے لیے ہیں۔",
  ...
  supplier_analysis: "سپلائر تجزیہ",
  supplier_analysis_purpose_tooltip:
    "ایک ہی آرٹیکل کی مختلف سپلائرز سے خریداری کی شرحوں کا موازنہ — سب سے سستا سپلائر، اس سے زیادہ ادا کی گئی رقم (ممکنہ بچت)، سپلائر پر اخراجات، اور اوسط لاگت سے زیادہ چلنے والی شرحیں نمایاں کرتا ہے۔",
  by_article: "آرٹیکل کے حساب سے",
  by_supplier: "سپلائر کے حساب سے",
  only_multi_supplier_articles: "صرف متعدد سپلائر والے آرٹیکلز",
  min_price_spread_pct: "کم از کم قیمت فرق ٪",
  articles_purchased: "خریدے گئے آرٹیکلز",
  multi_supplier_articles: "متعدد سپلائر آرٹیکلز",
  potential_savings: "ممکنہ بچت",
  num_suppliers: "سپلائرز",
  total_quantity: "کل مقدار",
  total_spend: "کل اخراجات",
  min_rate: "کم از کم شرح",
  max_rate: "زیادہ سے زیادہ شرح",
  avg_rate: "اوسط شرح",
  last_rate: "آخری شرح",
  price_spread: "فرق ٪",
  article: "آرٹیکل",
  articles_supplied: "آرٹیکلز",
  cheapest_supplier: "سب سے سستا سپلائر",
  dearest_supplier: "سب سے مہنگا سپلائر",
  above_wac: "اوسط لاگت سے زیادہ",
  above_wac_tooltip:
    "اس سپلائر کی اوسط شرح آئٹم کی وزنی اوسط لاگت سے زیادہ ہے۔",
  vs_cheapest: "سستے کے مقابلے میں",
  rate_premium_vs_cheapest: "سستے کے مقابلے اوسط اضافہ",
  weighted_avg_cost: "وزنی اوسط لاگت",
  ...
  buyer_type: "خریدار کی قسم",
  technical_details: "تکنیکی تفصیلات (اعلی)",
...
translations.ur = {
  ...
  dead_stock_report: "ڈیڈ اسٹاک رپورٹ",
  dead_stock_report_purpose_tooltip:
    "Selected period ke closing stock quantity aur value ko qty sold ke against dikhata hai, taake slow-moving aur dead stock articles identify ho sakein.",
  stock_count_accuracy_report: "اسٹاک کاؤنٹ ایکوریسی رپورٹ",
  stock_count_accuracy_report_purpose_tooltip:
    "Waqt ke sath (ہفتہ وار/ماہانہ/سالانہ) physical count system se kitna match hua, category ke lihaz se dikhata hai. Total unit (درجن) فرق aur total value فرق ke darmiyan trade-off dikhata hai. Value FG/SFG ki selling price (sale rate) hai; raw material kabhi bikta nahi is liye uski latest purchase rate use hoti hai.",
  period_grain: "مدت کی سطح",
  accuracy_trend: "ایکوریسی رجحان",
  quantity_accuracy: "مقدار کی درستگی",
  value_accuracy: "ویلیو کی درستگی",
  unit_difference: "یونٹ فرق",
  ...
  qty_sold_period: "فروخت شدہ مقدار (مدت)",
  turnover_ratio: "ٹرن اوور تناسب",
  turnover_ratio_tooltip:
    "Period mein Qty Sold ko Closing Qty se divide kiya jata hai. Zyada value fast-moving hai; 0 ke qareeb value ka matlab article stock ke muqable mein bohat kam bik raha hai.",
  days_of_stock_cover: "اسٹاک کوریج کے دن",
  days_of_stock_cover_tooltip:
    "Current average daily sales ki raftar par closing stock kitne dinon mein khatam hoga. Zyada value slow-moving hai; N/A ka matlab period mein koi sale nahi hui.",
  closing_qty: "کلوزنگ مقدار",
  closing_value: "کلوزنگ ویلیو",
  total_skus: "کل ایس کے یوز",
  dead_stock_sku_count: "ڈیڈ اسٹاک ایس کے یوز",
  dead_stock_value: "ڈیڈ اسٹاک ویلیو",
  sort_by: "ترتیب دیں",
  sort_closing_qty_desc: "زیادہ اسٹاک پہلے (سب سے زیادہ مقدار)",
  sort_turnover_ratio_asc: "سست ترین حرکت پہلے (کم ترین ٹرن اوور)",
  sort_stock_value_desc: "سب سے زیادہ ویلیو پہلے",
  packaging: "پیکیجنگ",
  stock_status_dead: "ڈیڈ",
  stock_status_slow: "سست حرکت",
  stock_status_healthy: "صحت مند",
  no_sales_in_period: "مدت میں کوئی فروخت نہیں",
  pending_returnables_purpose_tooltip:
...
Object.assign(translations.en, {
  ...
  yesterdays_sales: "Yesterday's Sales",
  yesterday: "Yesterday",
  monthly_revenue: "Monthly Revenue",
  monthly_purchase: "Monthly Purchase",
  dozens_sold_today: "Dozens Sold Today",
  dozens_sold_yesterday: "Dozens Sold Yesterday",
  dozens_sold_week: "Dozens Sold This Week",
  dozens_sold_month: "Dozens Sold This Month",
  dzn: "dzn",
  branch_performance: "Branch Performance",
  branch_performance_note:
    "Consolidated across all branches. Receivable/Payable are netted per party within each branch, so branch totals may differ slightly from the company-wide KPI.",
  ...
  order_pipeline_note:
    "Booked orders are commitments, not revenue — they are not included in Sales or Monthly Revenue. Order value is recognised as revenue only when the goods are delivered.",
  sales_group: "Sales",
  orders_booked: "Orders Booked",
  orders_booked_today: "Orders Booked Today",
  orders_booked_yesterday: "Orders Booked Yesterday",
  orders_booked_month: "Orders Booked This Month",
  open_order_value: "Open Order Value",
  pending_order_value: "Pending Order Value",
  advances_received_today: "Advances Received Today",
  advances_received_yesterday: "Advances Received Yesterday",
  advances_held_open_orders: "Advances Held (Open Orders)",
  month_to_date: "Month",
  production_progress: "Production Progress",
  dispatches_today: "Dispatches Today",
  dispatches_yesterday: "Dispatches Yesterday",
  critical_alerts: "Critical Alerts",
  alerts_needing_attention: "Alerts Needing Attention",
  all_clear: "All clear — no alerts right now.",
  overdue_customer_invoices: "Overdue Customer Invoices",
  overdue_supplier_bills: "Overdue Supplier Bills",
  raw_materials_below_min: "Raw Materials Below Minimum Stock",
  employees_absent_today: "Employees Absent Today",
  production_behind_schedule: "Production Orders Behind Schedule",
  purchase_orders_awaiting_receipt: "Purchase Orders Awaiting Receipt",
  ...
  master_data_approvals: "Master Data",
  hr_payroll_approvals: "HR & Payroll",
  other_approvals: "Other Approvals",
  view: "View",
  ...
  whatsapp_messages_not_sent: "WhatsApp messages not sent",
  recipient: "Recipient",
  phone: "Phone",
  previous: "Previous",
  wa_reason_no_phone: "No phone number on record",
  wa_reason_invalid_phone: "Invalid phone number",
  wa_reason_not_on_whatsapp: "Number is not on WhatsApp",
  wa_reason_ack_error: "WhatsApp rejected the message — number unreachable",
  wa_reason_not_delivered: "Delivery not confirmed by WhatsApp",
  wa_reason_client_unavailable: "WhatsApp not connected",
  wa_status_sent: "Sent",
  wa_status_failed: "Failed",
  wa_status_resolved: "Handled",
  wa_status_queued: "Waiting to retry",
  wa_reason_max_retries: "Gave up after repeated retries",
  wa_attempts: "Attempts",
  wa_next_retry: "next try",
  wa_filter_failed: "Failures",
...
Object.assign(translations.ur, {
  ...
  dozens_sold_today: "آج فروخت شدہ درجن",
  dozens_sold_yesterday: "کل فروخت شدہ درجن",
  dozens_sold_week: "اس ہفتے فروخت شدہ درجن",
  dozens_sold_month: "اس ماہ فروخت شدہ درجن",
  dzn: "درجن",
  branch_performance: "برانچ کارکردگی",
  branch_performance_note:
    "تمام برانچوں کا مجموعہ۔ قابل وصول/قابل ادا رقوم ہر برانچ میں فی پارٹی نیٹ کی گئی ہیں، اس لیے برانچ کے مجموعے کمپنی کے مجموعی KPI سے تھوڑے مختلف ہو سکتے ہیں۔",
  ...
  order_pipeline_note:
    "بک کیے گئے آرڈرز وعدے ہیں، آمدنی نہیں — یہ فروخت یا ماہانہ آمدنی میں شامل نہیں ہیں۔ آرڈر کی رقم صرف مال کی ترسیل پر آمدنی شمار ہوتی ہے۔",
  sales_group: "فروخت",
  orders_booked: "بک شدہ آرڈرز",
  orders_booked_today: "آج بک ہونے والے آرڈرز",
  orders_booked_yesterday: "کل بک ہونے والے آرڈرز",
  orders_booked_month: "اس ماہ بک ہونے والے آرڈرز",
  open_order_value: "کھلے آرڈرز کی مالیت",
  pending_order_value: "زیر التواء آرڈرز کی مالیت",
  advances_received_today: "آج موصولہ ایڈوانس",
  advances_received_yesterday: "کل موصولہ ایڈوانس",
  advances_held_open_orders: "ایڈوانس (کھلے آرڈرز پر)",
  month_to_date: "ماہ",
  production_progress: "پیداواری پیش رفت",
  dispatches_today: "آج کی ترسیلات",
  dispatches_yesterday: "کل کی ترسیلات",
  critical_alerts: "اہم انتباہات",
  alerts_needing_attention: "توجہ طلب انتباہات",
  all_clear: "سب ٹھیک ہے — فی الحال کوئی انتباہ نہیں۔",
  overdue_customer_invoices: "واجب الادا کسٹمر انوائسز",
  overdue_supplier_bills: "واجب الادا سپلائر بلز",
  raw_materials_below_min: "کم از کم اسٹاک سے کم خام مال",
  employees_absent_today: "آج غیر حاضر ملازمین",
  production_behind_schedule: "شیڈول سے پیچھے پیداواری آرڈرز",
  purchase_orders_awaiting_receipt: "وصولی کے منتظر خریداری آرڈرز",
  go_to_approval_center: "اپروول سینٹر پر جائیں",
  purchase_vouchers: "خریداری واؤچرز",
  sales_vouchers: "فروخت واؤچرز",
  journal_vouchers: "جرنل واؤچرز",
  payment_vouchers: "ادائیگی واؤچرز",
  inventory_adjustments: "انوینٹری ایڈجسٹمنٹس",
  leave_requests: "چھٹی کی درخواستیں",
  master_data_approvals: "ماسٹر ڈیٹا",
  hr_payroll_approvals: "ایچ آر اور پے رول",
  other_approvals: "دیگر منظوریاں",
  view: "دیکھیں",
  business_analytics: "کاروباری تجزیات",
  monthly_sales_trend: "ماہانہ فروخت کا رجحان",
  sales_vs_purchase: "فروخت بمقابلہ خریداری",
  revenue_vs_expenses: "آمدنی بمقابلہ اخراجات",
  top_selling_products: "10 سب سے زیادہ فروخت ہونے والی مصنوعات",
  production_by_stage: "مرحلہ وار پیداوار",
  inventory_status: "انوینٹری کی صورتحال",
  receivables_vs_payables: "قابل وصول بمقابلہ قابل ادائیگی",
  period_today: "آج",
  period_week: "اس ہفتے",
  period_month: "اس ماہ",
  period_year: "اس سال",
  period_custom: "حسب ضرورت",
  no_data_available: "کوئی ڈیٹا دستیاب نہیں",
  inv_available: "دستیاب",
  inv_reserved: "مختص شدہ",
  inv_low_stock: "کم اسٹاک",
  inv_out_of_stock: "اسٹاک ختم",
  load_more: "مزید دیکھیں",
  view_record: "ریکارڈ دیکھیں",
  ...
  whatsapp_messages_not_sent: "واٹس ایپ پیغامات نہیں بھیجے گئے",
  recipient: "وصول کنندہ",
  phone: "فون",
  previous: "پچھلا",
  wa_reason_no_phone: "ریکارڈ میں فون نمبر موجود نہیں",
  wa_reason_invalid_phone: "غلط فون نمبر",
  wa_reason_not_on_whatsapp: "یہ نمبر واٹس ایپ پر نہیں ہے",
  wa_reason_ack_error: "واٹس ایپ نے پیغام مسترد کر دیا — نمبر تک رسائی نہیں",
  wa_reason_not_delivered: "واٹس ایپ سے ڈیلیوری کی تصدیق نہیں ہوئی",
  wa_reason_client_unavailable: "واٹس ایپ منسلک نہیں",
  wa_status_sent: "بھیج دیا گیا",
  wa_status_failed: "ناکام",
  wa_status_resolved: "حل شدہ",
  wa_status_queued: "دوبارہ کوشش کے انتظار میں",
  wa_reason_max_retries: "بار بار کوشش کے بعد ناکام",
  wa_attempts: "کوششیں",
  wa_next_retry: "اگلی کوشش",
  wa_filter_queued: "قطار میں",
